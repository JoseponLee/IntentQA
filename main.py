...
from model.cmatt import CMAtten_Align
...
def main(args):
    ...
    triplet_loss = nn.TripletMarginLoss(margin=args.margin, p=args.p)
    align_att = CMAtten_Align()
    ...
    if not args.test:
        ...
        for epoch in range(args.epochs):
            train(model, train_loader, a2v, optimizer, criterion, triplet_loss, align_att, scheduler, epoch, args, bert_tokenizer)
