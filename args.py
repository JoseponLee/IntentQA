...
def get_args():
    ...
    parser.add_argument(
        "--margin", type=float, default=2.2, help="triplet loss margin"
    )
    parser.add_argument(
        "--p", type=int, default=2, help="triplet loss p"
    )

    # GPT
    parser.add_argument(
        "--GPT_result", type=str, default='', help="load gpt prior"
    )
    # contrast
    parser.add_argument(
        "--contrast_train_csv_path", type=str, default='', help="load gpt prior"
    )
